...
def get_labels(args):
    return [label.strip() for label in open("./bert_pipeline/data/labelJavi_grouped.txt", 'r', encoding='utf-8')]
    #./bert_pipeline/data/labelJavi_grouped.txt
    #./data/labelJavi_grouped.txt
def load_tokenizer(args):
    return MODEL_CLASSES[args.model_type][2].from_pretrained("./bert_pipeline/tokenizer")
    #./bert_pipeline/tokenizer
    #./tokenizer
def init_logger():
